...
public static class CombinedSolver
{
    ...
    public static bool IsSatisfiable(SmtFormula formula, CancellationToken cancellationToken = default) => SmtDriver.Solve(formula, Theory, cancellationToken).IsSatisfiable;
    ...
    public static bool IsValid(SmtFormula formula, CancellationToken cancellationToken = default) => !SmtDriver.Solve(new SmtNot(formula), Theory, cancellationToken).IsSatisfiable;
